...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Input:        SpikeTimesPerTrials - array of cells of size (1 x Trial_Count) where each 
%                   cell contains an array of spike times corresponding to one trial. Spike 
%                   times are aligned to the start of the trial and can take values between
%                   0 and TrialLength-1.
...
function [OscScore, CnfScore, OscFreq, AutoCorrelogram, AutoCorrelogramWithoutPeak, Spectrum] = ...
    ...
    for i=1:TrialCount
        ...
        [TrialOScores(i),Aux] = gng.batch.oscore_matlab.OScoreAC(TrialAutoCorrelograms(i,:), LowBoundFrequency, HighBoundFrequency, SamplingFrequency);
    end
    
    % compute oscillation score on the autocorrelogram for all trials
    AutoCorrelogram = sum(TrialAutoCorrelograms,1);
    [OscScore, OscFreq, AutoCorrelogramWithoutPeak, Spectrum] = gng.batch.oscore_matlab.OScoreAC(AutoCorrelogram, LowBoundFrequency, HighBoundFrequency, SamplingFrequency);
