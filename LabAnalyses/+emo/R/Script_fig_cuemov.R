...
#text(0.85,lsmeansTreat[3,1]+lsmeansTreat[3,2],"+",pos=3,cex=2,col="black")

#segments(0.35,lsmeansTreat[1,1]-lsmeansTreat[1,2]+(0.2*(lsmeansTreat[1,1]-lsmeansTreat[1,2])),0.58,lsmeansTreat[1,1]-lsmeansTreat[1,2]+(0.2*(lsmeansTreat[1,1]-lsmeansTreat[1,2])),col='black',lwd = 2)
#text(0.475,lsmeansTreat[1,1]-lsmeansTreat[1,2]+(0.2*(lsmeansTreat[1,1]-lsmeansTreat[1,2])),"***",pos=1,cex=3,col="black")
...
#text(0.6,lsmeansTreat[1,1]-lsmeansTreat[1,2]+(0.3*(lsmeansTreat[1,1]-lsmeansTreat[1,2])),"*",pos=1,cex=3,col="black")
