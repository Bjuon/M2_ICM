plot(Power.x,Power.y,xlim=c(0,2),ylim=c(-0.8,1),xlab="",ylab="", cex.lab=1.7,axes=F,type="n")

## lsmeansTreat
rect(0.25,0,0.45,lsmeansEmoTreat[1,1],border=NA,lwd=1,col='darkgreen',density=100)
rect(0.5,0,0.7,lsmeansEmoTreat[4,1],border=NA,lwd=1,col='darkgreen',density=100)

rect(0.85,0,1.05,lsmeansEmoTreat[5,1],border=NA,lwd=1,col='yellowgreen',density=100)
rect(1.1,0,1.3,lsmeansEmoTreat[8,1],border=NA,lwd=1,col='yellowgreen',density=100)

rect(1.45,0,1.65,lsmeansEmoTreat[9,1],border=NA,lwd=1,col='gold',density=100)
rect(1.70,0,1.90,lsmeansEmoTreat[12,1],border=NA,lwd=1,col='gold',density=100)
...
# neuneg off
segments(0.5,0,0.5,lsmeansEmoTreat[4,1],col='darkgreen',lwd=3)
segments(0.7,0,0.7,lsmeansEmoTreat[4,1],col='darkgreen',lwd=3)
segments(0.5,0,0.7,0,col='darkgreen',lwd=3)
segments(0.5,lsmeansEmoTreat[4,1],0.7,lsmeansEmoTreat[4,1],col='darkgreen',lwd=3)
segments(0.6,lsmeansEmoTreat[4,1]-lsmeansEmoTreat[4,2],0.6,lsmeansEmoTreat[4,1]+lsmeansEmoTreat[4,2],col='black',lwd=2)
...
# neuneg on
segments(1.1,0,1.1,lsmeansEmoTreat[8,1],col='yellowgreen',lwd=3)
segments(1.3,0,1.3,lsmeansEmoTreat[8,1],col='yellowgreen',lwd=3)
segments(1.1,0,1.3,0,col='yellowgreen',lwd=3)
segments(1.1,lsmeansEmoTreat[8,1],1.3,lsmeansEmoTreat[8,1],col='yellowgreen',lwd=3)
segments(1.2,lsmeansEmoTreat[8,1]-lsmeansEmoTreat[8,2],1.2,lsmeansEmoTreat[8,1]+lsmeansEmoTreat[8,2],col='black',lwd=2)
...
#text(1.075,lsmeansEmoTreat[5,1]-lsmeansEmoTreat[5,2]-0.1,"***",pos=1,cex=3,col="black")
...
# neuneg ocd
segments(1.70,0,1.70,lsmeansEmoTreat[12,1],col='gold',lwd=3)
segments(1.90,0,1.90,lsmeansEmoTreat[12,1],col='gold',lwd=3)
segments(1.70,0,1.90,0,col='gold',lwd=3)
segments(1.70,lsmeansEmoTreat[12,1],1.90,lsmeansEmoTreat[12,1],col='gold',lwd=3)
segments(1.8,lsmeansEmoTreat[12,1]-lsmeansEmoTreat[12,2],1.8,lsmeansEmoTreat[12,1]+lsmeansEmoTreat[12,2],col='black',lwd=2)

#segments(1.55,lsmeansEmoTreat[9,1]+lsmeansEmoTreat[9,2]+0.1,1.8,lsmeansEmoTreat[9,1]+lsmeansEmoTreat[9,2]+0.1,col='black',lwd = 2)
#text(1.675,lsmeansEmoTreat[9,1]+lsmeansEmoTreat[9,2]+0.1,"**",pos=3,cex=3,col="black")
