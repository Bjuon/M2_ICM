function batch_MAGIC_cass(varargin)
%% IDEES
% Artefact auto
% parfor et cluster
...
FigDir         = fullfile(startpath, '02_protocoles_data','02_Protocoles_Data','MAGIC','04_Traitement','01_POSTOP_Gait_data_MAGIC-GOGAIT','Figures', 'Mathys_Test', 'RAW');
