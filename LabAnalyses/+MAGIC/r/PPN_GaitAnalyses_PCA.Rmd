...
Modifié de l'analyse originelle réalisée pour le papier Gait Initiation (MAGIC + GOGAIT + GBMOV) - Aout 2024
...
cowplot::ggsave2(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "corrplot1.png"), plot = p, width = 35, height = 30, units = "cm")
```
...
knitr::include_graphics(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "corrplot1.png"))
```
...
cowplot::ggsave2(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", 'quantvar_violin1.png'), p, width = 35, height = 25, units = "cm")
```

```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "quantvar_violin1.png"))
```
...
cowplot::ggsave2(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", 'quantvar_groupXsubject.png'), width = 35, height = 25, units = "cm")
```

```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "quantvar_groupXsubject.png"))
```
...
df_temp %<>% 
  tidyr::drop_na() %>%
  mutate(Factor = interaction(Condition, Pat_Foggeur, is_FOG)) %>%
  mutate(Factor = forcats::fct_relevel(Factor, c("Sain.SS.FALSE", "OFF.NF.FALSE", "ON.NF.FALSE", "OFF.F.FALSE", "ON.F.FALSE", "OFF.F.TRUE", "ON.F.TRUE", "OFF.PPN.FALSE", "ON.PPN.FALSE", "OFF.PPN.TRUE", "ON.PPN.TRUE")))
...
cowplot::ggsave2(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", 'quantvar_violin_clean.png'), p, width = 35, height = 25, units = "cm")
```

```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "quantvar_violin_clean.png"))
```
...
cowplot::ggsave2(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", 'quantvar_groupXsubject_clean.png'), width = 35, height = 25, units = "cm")
```

```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "quantvar_groupXsubject_clean.png"))
```
...
cowplot::ggsave2(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "corrplot2.png"), plot = p, width = 35, height = 20, units = "cm")
```

```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "corrplot2.png"))
```
...
p <- e + f + g
cowplot::ggsave2(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "pca_loadings.png"), plot = p, width = 30, height = 25, units = "cm")
```

Let's look at the loadings to see if we can interpret anything.
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "pca_loadings.png"))
```
...
p <- ggplot(df_mean, aes(Factor, value, group = Subject, color = Subject)) +
  ...
  geom_line(data = df_mean_of_means %>% 
              filter(Factor %in% c("OFF.PPN.FALSE", "ON.PPN.FALSE", "OFF.PPN.TRUE", "ON.PPN.TRUE")), 
            aes(Factor, value), color = "Red", size = 3, alpha = 0.25) +
  geom_line(data = df_mean_of_means%>% 
...
# cowplot::ggsave2(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "scores_varimax.png"), plot = p, width = 35, height = 26, units = "cm")
cowplot::ggsave2(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "scores_varimax.png"), plot = p, width = 35, height = 55, units = "cm")
```

Let's look at subject-level mean scores (unrotated [PC] and varimax rotated [RPC]),
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "scores_varimax.png"))
```
...
cowplot::ggsave2(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "ellipse_conf_RPC12.svg"), plot = p, width = 40, height = 40, units = "cm")
...
p = ggplot(df_scores_local, aes(x = RPC.1, y = RPC.5, color = NULL, fill = Factor)) +
  ...
  labs(x = "RPC1", y = "RPC5") +
  theme(legend.position = "none")
cowplot::ggsave2(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "ellipse_conf_RPC15.svg"), plot = p, width = 40, height = 40, units = "cm")
...
p = ggplot(df_scores_local, aes(x = RPC.2, y = RPC.5, color = NULL, fill = Factor)) +
  ...
  labs(x = "RPC2", y = "RPC5") +
  theme(legend.position = "none")
cowplot::ggsave2(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "ellipse_conf_RPC25.svg"), plot = p, width = 40, height = 40, units = "cm")
...
for (i in vars) {
  ...
  P[[i]] <- P[[i]] +
    ylab("") + xlab("") + 
    ggtitle(switch(as.numeric(str_extract(i, "[1-9]")), "Pace (RPC 1)", "Rhythm (RPC 2)", "Vertical (RPC 3)", "Balance (RPC 4)", "Lateral (RPC 5)")) +
    theme_pubr(legend = "bottom") +
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "lmer_varimax_red_FOG.png"))
```
```{r, echo = F, results = "hide", message = FALSE, warning = FALSE, out.width = '100%'}
TodoComparisons = "FOG" # "FOG" or "FNF"
...
p <- wrap_plots(P, nrow = 1) + plot_layout(guides = "collect")
cowplot::ggsave2(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "lmer_varimax_red_FOG.png"), plot = p, width = 45, height = 20, units = "cm")
```
...
cowplot::ggsave2(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "cor_pc.png"), plot = q, width = 45, height = 45, units = "cm")
```

Marginal means, CIs, p-values (FDR-corrected) for varimax rotated (RPC),
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "cor_pc.png"))
```
...
cowplot::ggsave2(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "cor_pc_perGP.png"), plot = q, width = 90, height = 30, units = "cm")
TestsImportants %>% kable()
```

Marginal means, CIs, p-values (FDR-corrected) for varimax rotated (RPC),
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "cor_pc_perGP.png"))
```
...
q = wrap_plots(p, nrow = 2) + plot_layout(guides = "collect")
# cowplot::ggsave2(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "cor_pc_perGP.png"), plot = q, width = 90, height = 30, units = "cm")q
```
...
for(fact in c("OFF.PPN.FALSE", "ON.PPN.FALSE", "OFF.PPN.TRUE", "ON.PPN.TRUE")) {
  ...
  pval = df_scores  %>% filter(Factor == fact) %>% select(contains("RPC")) %>% cor_pmat()
  print(pval)
  df_corr = df_scores %>% filter(Factor == fact) %>%
    select(contains("RPC")) %>% 
    cor()
  df_corr_na = df_corr 
  df_corr_na[pval[1:5,1:5] > 0.05] = NA
  diag(df_corr_na) = NA
  print(df_corr_na) ; print("")
  
  plot1 = df_corr %>%
  ggcorrplot::ggcorrplot(hc.order = F, type = "lower",
           outline.color = "white",
           colors = c("#8888FF", "white", "#FF8888"),
...
cowplot::ggsave2(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "beta_vars.png"), plot = p, width = 55, height = 26, units = "cm")
...
cowplot::ggsave2(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "beta_PC_scores.png"), plot = p, width = 55, height = 15, units = "cm")
...
p <- cowplot::plot_grid(plotlist = P, nrow = 1, ncol = 5)
cowplot::ggsave2(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "beta_RPC_scores.png"), plot = p, width = 55, height = 15, units = "cm")
```
...
p <- cowplot::plot_grid(plotlist = P[str_replace(names(sort(unlist(marginal_r2), decreasing = T)), ".Marginal R2", "")], nrow = 4, ncol = 5)
cowplot::ggsave2(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "beta_vars_w_condition.png"), plot = p, width = 55, height = 26, units = "cm")
...
p <- cowplot::plot_grid(plotlist = P, nrow = 1, ncol = 5)
cowplot::ggsave2(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "beta_PC_scores_w_condition.png"), plot = p, width = 55, height = 15, units = "cm")
...
p <- cowplot::plot_grid(plotlist = P, nrow = 1, ncol = 5)
cowplot::ggsave2(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "beta_RPC_scores_w_condition.png"), plot = p, width = 55, height = 15, units = "cm")
```
...
knitr::include_graphics(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "beta_vars.png"))
```

PCs
```{r echo=FALSE, eval=FALSE, out.width = '100%'}
knitr::include_graphics(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "beta_PC_scores.png"))
```

RPCs
```{r echo=FALSE, eval=FALSE, out.width = '100%'}
knitr::include_graphics(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "beta_RPC_scores.png"))
```
...
Variables
```{r echo=FALSE, eval=FALSE, out.width = '100%'}
knitr::include_graphics(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "beta_vars_w_condition.png"))
```

PCs
```{r echo=FALSE, eval=FALSE, out.width = '100%'}
knitr::include_graphics(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "beta_PC_scores_w_condition.png"))
```

RPCs
```{r echo=FALSE, eval=FALSE, out.width = '100%'}
knitr::include_graphics(paste0("C:/LustreSync/LAU Brian - 2024_GBMOV/","FiguresPPN/", "beta_RPC_scores_w_condition.png"))
```
