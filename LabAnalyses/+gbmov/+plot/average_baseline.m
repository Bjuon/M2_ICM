...
figure;
subplot(211); hold on
plot(f,nanmean(POFF,2),'b');
plot(f,nanmean(PON,2),'r');
%set(gca,'xscale','log');
axis tight;
axis([2 100 get(gca,'ylim')]);
subplot(212);hold on
plot(f,nanmean(SigOFF,2),'b');
plot(f,nanmean(SigON,2),'r');
%set(gca,'xscale','log');
axis tight;
axis([2 100 get(gca,'ylim')]);
...
figure;
subplot(211); hold on
plot(f,nanmean(POFF(:,therapeuticOFF==1),2),'b');
plot(f,nanmean(POFF(:,therapeuticOFF==0),2),'b--');
plot(f,nanmean(PON(:,therapeuticON==1),2),'r');
plot(f,nanmean(PON(:,therapeuticON==0),2),'r--');
set(gca,'xscale','log');
axis tight;
axis([2 500 get(gca,'ylim')]);
subplot(212);hold on
plot(f,nanmean(SigOFF(:,therapeuticOFF==1),2),'b');
plot(f,nanmean(SigOFF(:,therapeuticOFF==0),2),'b--');
plot(f,nanmean(SigON(:,therapeuticON==1),2),'r');
plot(f,nanmean(SigON(:,therapeuticON==0),2),'r--');
set(gca,'xscale','log');
axis tight;
axis([2 500 get(gca,'ylim')]);
