...
% P01Rouen
    ...
    disp('Changer le dossier d origine à 4 ENDROITS !!!')
...
cd(['C:\Users\mathieu.yeche\Desktop\VICON\DATA_OK\' Patient ]);
...
clearvars -except cpt cpt2 APA filename num_trial_omission num_trial_NoGo_OK num_trial_NoGo_Bad Times Fs n h Patient Session num_trial nt Cond Ev MARCHE Date Type listFOG % Trajectoires Events2
...
%% CLEAR
clearvars -except cpt cpt2 APA Patient Session num_trial_omission num_trial_NoGo_OK num_trial_NoGo_Bad num_trial nt MARCHE Cond Type Date listFOG
...
if exist('num_trial_omission','var')
    for nt = 1:length(num_trial_omission)
        ...
        disp(['Essai n°' num_trial_omission{nt}])
        % Dossier ou se trouve l'essai
%         cd(['\\lexport\iss01.pf-marche\temp\temp\LINKERS_Logfiles\DATA_t0\' Patient ]);
        cd(['C:\Users\mathieu.yeche\Desktop\VICON\DATA_OK\' Patient ]);
        % Lecture de l'essai (fichier c3d)
        ...
        DATA.QUALITY = 99;
        OMIS.DATA(nt) = DATA;
        clearvars -except cpt cpt2 Patient NOGO OMIS Session num_trial_omission num_trial_NoGo_OK num_trial_NoGo_Bad num_trial nt MARCHE Cond Type Date listFOG
    end
end
...
cpt2=cpt2+1;
NOGO.DATA(nt) = DATA;
clearvars -except cpt cpt2 Patient NOGO OMIS Session num_trial_NoGo_OK num_trial_NoGo_Bad num_trial nt MARCHE Cond Type Date listFOG
end
...
clearvars -except cpt Patient NOGO OMIS cpt2 Session num_trial_NoGo_OK num_trial_NoGo_Bad num_trial nt MARCHE Cond Type Date listFOG
end
