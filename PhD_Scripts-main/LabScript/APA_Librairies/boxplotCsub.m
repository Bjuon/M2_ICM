...
%   BFGK 10-jun-2010
%       fatter      multiplier to vary width of given dataset. Default = 1
...
%                       8: boxfill (if used)
%
% As the syntax for boxplot has changed in MatLab 2010, I include the text
% from the old boxplot help here for syntax:
%
