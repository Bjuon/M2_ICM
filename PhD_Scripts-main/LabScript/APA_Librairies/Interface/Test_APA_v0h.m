function varargout = Test_APA_v0h(varargin)
% TEST_APA_V0H MATLAB code for Test_APA_v0h.fig
%      TEST_APA_V0H, by itself, creates a new TEST_APA_V0H or raises the existing
%      singleton*.
%
%      H = TEST_APA_V0H returns the handle to a new TEST_APA_V0H or the handle to
%      the existing singleton*.
%
%      TEST_APA_V0H('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TEST_APA_V0H.M with the given input arguments.
%
%      TEST_APA_V0H('Property','Value',...) creates a new TEST_APA_V0H or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Test_APA_v0h_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Test_APA_v0h_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Test_APA_v0h

% Last Modified by GUIDE v2.5 18-Apr-2012 13:37:00

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Test_APA_v0h_OpeningFcn, ...
                   'gui_OutputFcn',  @Test_APA_v0h_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Test_APA_v0h is made visible.
function Test_APA_v0h_OpeningFcn(hObject, eventdata, handles, varargin)
...
% varargin   command line arguments to Test_APA_v0h (see VARARGIN)

% Choose default command line output for Test_APA_v0h
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Test_APA_v0h wait for user response (see UIRESUME)
% uiwait(handles.figure1);
set(gcf,'Name','Calcul des APA v.0h');
...
function varargout = Test_APA_v0h_OutputFcn(hObject, eventdata, handles) 
...
% Vérification que l'acquisition existe
...
global haxes1 haxes2 haxes3 haxes4 Sujet dossier EMG
...
eval(['save ' Subject_data.ID ' Sujet Resultats Corridors Subject_data EMG liste_actuelle']);
