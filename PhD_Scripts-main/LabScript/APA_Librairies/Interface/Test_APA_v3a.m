function varargout = Test_APA_v3a(varargin)
% TEST_APA_V3A MATLAB code for Test_APA_v3a.fig
%      TEST_APA_V3A, by itself, creates a new TEST_APA_V3A or raises the existing
%      singleton*.
%
%      H = TEST_APA_V3A returns the handle to a new TEST_APA_V3A or the handle to
%      the existing singleton*.
%
%      TEST_APA_V3A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TEST_APA_V3A.M with the given input arguments.
%
%      TEST_APA_V3A('Property','Value',...) creates a new TEST_APA_V2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Test_APA_v3a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Test_APA_v3a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Test_APA_v3a

% Last Modified by GUIDE v2.5 12-Feb-2014 16:34:57

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Test_APA_v3a_OpeningFcn, ...
                   'gui_OutputFcn',  @Test_APA_v3a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function Test_APA_v3a_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = Test_APA_v3a_OutputFcn(hObject, eventdata, handles) 
