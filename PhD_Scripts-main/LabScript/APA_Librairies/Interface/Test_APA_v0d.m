function varargout = Test_APA_v0d(varargin)
% TEST_APA_V0D MATLAB code for Test_APA_v0d.fig
%      TEST_APA_V0D, by itself, creates a new TEST_APA_V0D or raises the existing
%      singleton*.
%
%      H = TEST_APA_V0D returns the handle to a new TEST_APA_V0D or the handle to
%      the existing singleton*.
%
%      TEST_APA_V0D('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TEST_APA_V0D.M with the given input arguments.
%
%      TEST_APA_V0D('Property','Value',...) creates a new TEST_APA_V0D or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Test_APA_v0d_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Test_APA_v0d_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Test_APA_v0d

% Last Modified by GUIDE v2.5 04-Apr-2012 20:07:13

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Test_APA_v0d_OpeningFcn, ...
                   'gui_OutputFcn',  @Test_APA_v0d_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Test_APA_v0d is made visible.
function Test_APA_v0d_OpeningFcn(hObject, ~, handles, varargin)
...
% varargin   command line arguments to Test_APA_v0d (see VARARGIN)

% Choose default command line output for Test_APA_v0d
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Test_APA_v0d wait for user response (see UIRESUME)
...
function varargout = Test_APA_v0d_OutputFcn(hObject, eventdata, handles) 
