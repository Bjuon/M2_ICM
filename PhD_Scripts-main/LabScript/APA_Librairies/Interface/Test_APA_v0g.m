function varargout = Test_APA_v0g(varargin)
% TEST_APA_V0G MATLAB code for Test_APA_v0g.fig
%      TEST_APA_V0G, by itself, creates a new TEST_APA_V0G or raises the existing
%      singleton*.
%
%      H = TEST_APA_V0G returns the handle to a new TEST_APA_V0G or the handle to
%      the existing singleton*.
%
%      TEST_APA_V0G('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TEST_APA_V0G.M with the given input arguments.
%
%      TEST_APA_V0G('Property','Value',...) creates a new TEST_APA_V0G or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Test_APA_v0g_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Test_APA_v0g_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Test_APA_v0g

% Last Modified by GUIDE v2.5 16-Apr-2012 12:20:09

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Test_APA_v0g_OpeningFcn, ...
                   'gui_OutputFcn',  @Test_APA_v0g_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Test_APA_v0g is made visible.
function Test_APA_v0g_OpeningFcn(hObject, eventdata, handles, varargin)
...
% varargin   command line arguments to Test_APA_v0g (see VARARGIN)

% Choose default command line output for Test_APA_v0g
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Test_APA_v0g wait for user response (see UIRESUME)
...
set(gcf,'Name','Calcul des APA v.0g');
...
function varargout = Test_APA_v0g_OutputFcn(hObject, eventdata, handles) 
...
global haxes1 haxes2 haxes3 haxes4 Sujet EMG dossier
