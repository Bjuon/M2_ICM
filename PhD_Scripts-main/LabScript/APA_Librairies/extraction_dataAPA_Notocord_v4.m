function [Donnes Res] = extraction_dataAPA_Notocord_v4(files,dossier,sub_grp)
...
for i = 1:nb_fich
    ...
    for k = 1:nb_acq
        ...
        try
            ...
            Donnes.(acq).primResultats.V1 = [floor((sujet.V.T_VzMin/1e3 +sujet.V.T_OnsetACC)*Freq_vid) sujet.V.Vz_min_value] ;
        end
        ...
        try
            ...
            if strcmp(upper(tags{5}),'VS') || strcmp(upper(tags{5}),'PS')
                Res.(acq).Condition = upper(tags{end}(1));
            else
