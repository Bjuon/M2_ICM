function FICH=lire_donnees_c3d(nom_c3d);
...
% si la fréquence d'aquis des données analogiques est différentes de celle
% des ces coordonnées on échantillonne a la plus petite des fréquences.
try
