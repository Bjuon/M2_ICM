function R = calculs_parametres_initiationPas_v1a(Acq)
...
if isfield(Acq,'Trigger')
    R.Im_trig = round(T_trig*Fech_vid);
end
R.Im_T0 = round(tMarkers.T0*Fech_vid);
R.Im_HO = round(tMarkers.HO*Fech_vid);
R.Im_TO = round(tMarkers.TO*Fech_vid);
R.Im_FC1 = round(tMarkers.FC1*Fech_vid);
R.Im_FO2 = round(tMarkers.FO2*Fech_vid);
R.Im_FC2 = round(tMarkers.FC2*Fech_vid);
