function varargout = Test_APA_v3e(varargin)
% TEST_APA_V3E MATLAB code for Test_APA_v3e.fig
%      TEST_APA_V3E, by itself, creates a new TEST_APA_V3E or raises the existing
%      singleton*.
%
%      H = TEST_APA_V3E returns the handle to a new TEST_APA_V3E or the handle to
%      the existing singleton*.
%
%      TEST_APA_V3E('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TEST_APA_V3E.M with the given input arguments.
%
%      TEST_APA_V3E('Property','Value',...) creates a new test_apa_v3e or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Test_APA_v3e_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Test_APA_v3e_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Test_APA_v3e

% Last Modified by GUIDE v2.5 09-Jul-2014 15:07:31

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @Test_APA_v3e_OpeningFcn, ...
    'gui_OutputFcn',  @Test_APA_v3e_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
%% Test_APA_v3e_OpeningFcn -Funcion principale
% --- Executes just before Test_APA_v3e is made visible.
function Test_APA_v3e_OpeningFcn(hObject, eventdata, handles, varargin)
...
% varargin   command line arguments to Test_APA_v3e (see VARARGIN)

% Choose default command line output for Test_APA_v3e
...
set(gcf,'Name','Calcul des APA v.3e');
...
function varargout = Test_APA_v3e_OutputFcn(hObject, eventdata, handles)
...
try
    ...
    [Sujet EMG] = pretraitement_dataAPA_v7a(files,dossier_c3d(1:end-1),button_cut);
...
% --- Executes when Test_APA_v3e is resized.
function Test_APA_v3e_ResizeFcn(hObject, eventdata, handles)
% hObject    handle to Test_APA_v3e (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
